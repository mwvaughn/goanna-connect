...
GetOptions("PROGRAM=s" => \$PROGRAM, 'EMAIL=s' => \$EMAIL, 'file_type=s' => \$file_type, 'search_field=s' => \$search_field, 'ID_LIST=s' => \$ID_LIST, 'DATABASE=s{1,3}' => \$DATABASE, 'no_iea=i' => \$no_iea, 'EXPECT=i' => \$EXPECT, 'WORD_SIZE=s' => \$WORD_SIZE,
